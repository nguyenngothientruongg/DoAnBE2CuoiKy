...
<head>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            var countriesLink = document.getElementById("countriesLink");
            ...
            function setActiveLink() {
                ...
                else if (currentUrl.includes("{{route('admin.countriesList')}}")){
                    countriesLink.classList.add("active");
                    countriesLink.style.color = "white";
                    countriesLink.style.borderBottom = "2px solid white";
                }
                else if (currentUrl.includes("{{route('admin.registrationCountries')}}")){
                    addLink.classList.add("active");
                    addLink.style.color = "white";
                    addLink.style.borderBottom = "2px solid white";
                }
            }
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="mynavbar">
                ...
                @elseif (Auth::user()->permission == '1')
                    <div class="collapse navbar-collapse" id="mynavbar">
                        ...
                        <ul class="navbar-nav me-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link mx-3" id="userLink" href="{{ route('admin.userList') }}">Danh sách
                                    User</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link mx-3" id="countriesLink" href="{{ route('admin.countriesList') }}">Danh
                                    sách
                                    Quốc gia</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link me-3" id="addLink" href="{{ route('admin.registrationCountries') }}">Thêm
                                    quốc gia</a>
                            </li>
                        </ul>

                        <form class="d-flex" style="margin-top: 18px">
                            <input style="width: 240px" class="form-control me-2" type="text"
                                placeholder="Nhập phim cần tìm..." name="key">
                            <button class="btn text-white"
                                style="width: 100px; background-color: white; background-color: #FF0000;" type="submit">Tìm
                                kiếm</button>
                        </form>
                        <a href="{{ route('signout') }}"><i class="fa-solid fa-user-tie"
                                style="color: white; font-size: 37px; margin-left: 20px; margin-right: 10px;"></i></a>
                ...
                @else
                    ...
                    <form class="d-flex" style="margin-top: 18px" action="{{route('user.searchMovie')}}">
                        <input class="form-control me-2" name="key" type="text" placeholder="Nhập phim cần tìm...">
                        <button class="btn text-white"
                            style="width: 121px; background-color: white; background-color: #FF0000;" type="submit">Tìm
                            kiếm</button>
                    </form>
                    @if(Auth::check())
                        <div class="dropdown" style="margin-right: 50px;">
                            <img src="{{ asset(Auth::user()->images) }}" alt="User Avatar" id="userDropdown"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                style="width: 43px; height: 43px; margin-left: 20px; margin-right: 10px; border-radius: 50%; cursor: pointer;">
                            <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" href="{{ route('user.profileUser', Auth::user()->id) }}"
                                    style="font-weight: 700px">Trang cá nhân</a>
                                <a class="dropdown-item" style="font-weight: 700px" href="{{ route('signout') }}">Đăng xuất</a>
                            </div>
                        </div>
                    @else
