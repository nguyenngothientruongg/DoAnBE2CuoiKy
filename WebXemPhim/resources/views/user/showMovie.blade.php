...
<header>
    <h4 class="section-title text-white Top10ShowInVN">Không phải sợ vì hết phim xem. Gợi ý tiếp theo</h4>
</header>

<section class="row" style="overflow-y: auto;">
    <div class="col-12">
        <div class="d-flex flex-row">
            @foreach($movies->take(14) as $moviee)
                <div class="col-sm-6 col-md-4 col-lg-3 px-1">
                    <a href="{{ route('user.showMovie', ['id' => $moviee->id, 'tuoi' => \Carbon\Carbon::parse(Auth::user()->date)->age]) }}"
